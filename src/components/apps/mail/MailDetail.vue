...
<template>
  ...
  <div class="py-3 d-flex ga-4">
    <v-btn color="primary" variant="outlined" rounded="md"
      ><SvgSprite name="custom-edit-outline" class="mr-1" style="width: 16px; height: 16px" /> Reply</v-btn
    >
    <v-btn color="primary" variant="outlined" rounded="md"
      ><SvgSprite name="custom-forward-outline" class="mr-1" style="width: 16px; height: 16px" /> Forward</v-btn
    >
  </div>
</template>
