  ...
  <perfect-scrollbar class="mb-3" style="height: 430px">
    <v-list aria-label="chat list" aria-busy="true" border>
      ...
      >
        ...
        <!---Name-->
        <v-list-item-title class="text-h5 pr-2 mb-1">{{ chat.name }}</v-list-item-title>
        <!---Subtitle-->
        ...
        <template v-slot:append>
          <div class="d-flex flex-column text-right">
            ...
            <SvgSprite v-else name="custom-circle-check-outline" class="ml-auto text-lightText" style="width: 16px; height: 16px" />
          </div>
        </template>
      </v-list-item>
    </v-list>
