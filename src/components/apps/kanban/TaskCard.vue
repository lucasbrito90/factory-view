      ...
      <div class="d-flex align-start ga-2">
        <div class="d-block text-truncate">
          ...
          <a class="text-primary text-caption d-flex align-center cursor-pointer">
            <SvgSprite name="custom-user-story-outline" class="mr-1" style="width: 16px; height: 16px" /> User Story #{{
              props.task?.userStory
            }}
          </a>
        </div>
        <v-btn icon size="x-small" aria-label="menu" variant="text" rounded="md" class="ml-auto">
