...
import { getdarkPrimary, getPrimary, getDarkText, getSecondary, getdarkSecondary } from '../../../forms/charts/apex-chart/UpdateColors';
...
const chartOptions = computed(() => {
  return {
    ...
    colors: [getdarkPrimary.value, getPrimary.value, getSecondary.value, getdarkSecondary.value, getdarkSecondary.value, getDarkText.value],
    legend: {
      show: false
    },
    fill: {
          ...
          <v-card variant="outlined" rounded="lg">
            <v-card-item class="py-3">
              <div class="d-flex justify-center">
                <v-avatar size="6" color="darkText" variant="flat" class="mt-2 mr-3"> </v-avatar>
                <div>
