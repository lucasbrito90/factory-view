    ...
    <v-card-item class="px-0 pb-0">
      ...
      <v-table class="bordered-table" hover>
        <thead class="bg-containerBg">
          <tr>
            <th class="text-left text-uppercase text-caption font-weight-bold py-0 pl-6" style="height: 51px">Customer</th>
            <th class="text-left text-uppercase text-caption font-weight-bold py-0" style="height: 51px">Plan</th>
            <th class="text-right text-uppercase text-caption font-weight-bold py-0 pr-6" style="height: 51px">MRP</th>
          </tr>
        </thead>
        <tbody>
          <tr v-for="item in revenueData" :key="item.name" class="text-lighttext">
            <td class="text-subtitle-1 font-weight-regular py-4 pl-6" style="min-width: 200px">
              <v-avatar size="32" color="containerBg" variant="flat" rounded="md" class="mr-2">
            ...
            <td class="text-subtitle-1 text-right pr-6">
