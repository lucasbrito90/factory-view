    ...
    <v-card-item class="pt-0">
      <v-list class="pb-0 pt-1" aria-label="task" aria-busy="true">
        <v-list-item class="pa-0">
          ...
          <h5 class="text-h5 mb-0">New Task <v-chip color="secondary" class="ml-1" size="small" variant="tonal">20</v-chip></h5>
        </v-list-item>
      </v-list>
      ...
      <v-list class="py-5" aria-label="task list" aria-busy="true">
        <v-list-item class="no-spacer" v-for="(item, i) in tasks" :key="i" :value="item" rounded="md">
          <template v-slot:prepend>
            <v-avatar size="8" :color="item.color" variant="flat" class="mr-3"> </v-avatar>
          </template>
