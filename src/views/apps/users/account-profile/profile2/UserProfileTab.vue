...
<template>
  <div>
    <div class="d-flex flex-row">
      <img src="@/assets/images/users/avatar-1.png" class="rounded-md" width="80" alt="user-img" />
      <div class="ml-4 d-flex align-center text-subtitle-2 text-medium-emphasis font-weight-medium">
        <SvgSprite name="custom-info-circle-outline" class="mr-2" style="width: 16px; height: 16px" /> Image size Limit should be 125kb Max.
      </div>
    </div>
    <v-row class="mt-6">
      <v-col cols="12" md="6">
