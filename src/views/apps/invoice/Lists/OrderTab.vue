    ...
    <v-card-item>
      <v-tabs v-model="tab" color="primary">
        <v-tab value="1" class="font-weight-medium">
          All
          <v-chip color="primary" class="ml-2 font-weight-medium" size="small"> 5 </v-chip>
        </v-tab>
        <v-tab value="2" class="font-weight-medium">
          Paid
          <v-chip color="success" class="ml-2 font-weight-medium" size="small"> 2 </v-chip>
        </v-tab>
        <v-tab value="3" class="font-weight-medium">
          Unpaid
          <v-chip color="warning" class="ml-2 font-weight-medium" size="small"> 2 </v-chip>
        </v-tab>
        <v-tab value="4" class="font-weight-medium">
          Cancelled
          <v-chip color="error" class="ml-2 font-weight-medium" size="small"> 1 </v-chip>
        </v-tab>
      </v-tabs>
      <v-divider></v-divider>
    </v-card-item>
